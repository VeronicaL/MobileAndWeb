...
public class MainPageObject {
    ...
    protected void swipeUp(int timeOfSwipe){
        if (driver instanceof AppiumDriver) {
            ...
            System.out.println("swipeUp() does nothing for " + Platform.getInstance().getPlatformVar());
        }
    }
    ...
    public void scrollWebPageUp(){
        if (Platform.getInstance().isMW()) {
            ...
            System.out.println("scrollWebPageUp() does nothing for " + Platform.getInstance().getPlatformVar());
        }
    }

    public void scrollWebPageTillElementNotVisible(String locator, String errorMsg, int maxSwipes){
        int alreadySwiped = 0;
        WebElement element = this.waitForElementPresent(locator, errorMsg);
        while (!this.isElementLocatedOnTheScreen(locator)){
            scrollWebPageUp();
            System.out.println("Scrolled:" + alreadySwiped);
            alreadySwiped++;
            if (alreadySwiped > maxSwipes) {
                Assert.assertTrue(errorMsg, element.isDisplayed());
            }
        }
    }
    ...
    public void clickElementToTheRightUpperCorner(String locator, String errorMessage){
        if (driver instanceof AppiumDriver) {
            ...
            System.out.println("clickElementToTheRightUpperCorner() does nothing for " + Platform.getInstance().getPlatformVar());
        }
    }
    ...
    public void swipeElementToLeft(String locator, String error_message){
        if (driver instanceof AppiumDriver) {
            ...
            System.out.println("swipeElementToLeft() does nothing for " + Platform.getInstance().getPlatformVar());
        }
    }
